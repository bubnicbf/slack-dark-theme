...
5. Lastly, open up ssb-interop.bundle.js. It's within our new /app folder (/app/dist/ssb-interop.bundle.js). Paste something like this at the very bottom of the file (you can alter the CSS to your tastes). 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let tt__customCss = `
        ...
        .p-prefs_modal .c-radiogroup .c-label--with_formatted_text { background:  rgba(50, 82, 102, 0.85); }
        ...
        .p-workspace__input .p-message_input_field { border-color: rgba(50, 82, 102, 0.4); }
        ...
        .p-threads_footer__input .p-message_input_field .ql-editor p {color: rgb(50, 82, 102);}
        .c-message--highlight.c-message--editing { background: rgb(27, 139, 210);}
        .p-classic_nav__model__title__name--dim, .c-texty_input .c-texty_input__button, .p-workspace__input .p-message_input_file_button { color: rgba(51, 133, 145,0.3); }
        ...
        .p-threads_view_reply, .p-threads_view_root, .p-threads_view__footer, .p-classic_nav__right__search { border: 1px solid rgba(50, 82, 102,0.4); }
    `;
